...
INSERT INTO member (age, create_date, deleted, email, gender, height, hobby, introduce, locate, mbti_name, modify_date,
                    nickname, password, profile_image, provider_type, user_id, username)
